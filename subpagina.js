      ...
      if (result.isConfirmed) {
        ...
        if (formPopup) {
          formPopup.document.write(
            '<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfKPs_Jp6MCMcpa2JvIQOH0Cyif5a2OZmFYplByXTSRPeP11A/viewform?embedded=true" width="640" height="1567" frameborder="0" marginheight="0" marginwidth="0">Carregando…</iframe>'
          );
        } else {
          // Utilizando o SweetAlert2 para uma caixa de diálogo mais atraente
          Swal.fire({
