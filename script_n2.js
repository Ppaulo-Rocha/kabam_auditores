      ...
      if (result.isConfirmed) {
        ...
        if (formPopup) {
          formPopup.document.write(
            '<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfn8GiI7YZxS_t636aOarIyuaoABY9n0KZ9uct_YN-5DqitQw/viewform?embedded=true" width="640" height="1219" frameborder="0" marginheight="0" marginwidth="0">Carregando…</iframe>'
          );
        } else {
          // Utilizando o SweetAlert2 para uma caixa de diálogo mais atraente
          Swal.fire({
